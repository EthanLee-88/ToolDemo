...
public class TImageListBgView extends RelativeLayout {
    ...
    private com.ethan.pagerview.ui.TRect originalRect;
    public List<com.ethan.pagerview.ui.TRect> originalRects;
    ...
    private com.ethan.pagerview.ui.TPageHorizatalScrollView horizontalScrollView;
    private TPageControl pageControl;

    public TImageListBgView(Context context, com.ethan.pagerview.ui.TRect originalRect, Object imageId, List<Object> imageIds, int currentIndex) {
        super(context);
    ...
    private void initImageListBgView() {
        ...
        layoutParams.width = com.ethan.pagerview.ui.TRect.getScreenWidth(getContext());
        layoutParams.height = com.ethan.pagerview.ui.TRect.getScreenHeight(getContext());
...
//        Picasso.with(getContext()).load("http://ww2.sinaimg.cn/mw690/9e6995c9gw1f2uu70bzohj209q06g3yw.jpg").into(animationIV);
    ...
    private void initHorizontalScrollView() {
        horizontalScrollView = new com.ethan.pagerview.ui.TPageHorizatalScrollView(getContext());
        LayoutParams hsLayoutParams = new LayoutParams(com.ethan.pagerview.ui.TRect.getScreenWidth(getContext()), com.ethan.pagerview.ui.TRect.getScreenHeight(getContext()));
        hsLayoutParams.leftMargin = 0;
        hsLayoutParams.topMargin = 0;
        addView(horizontalScrollView,hsLayoutParams);
        horizontalScrollView.mBaseScrollX = currentIndex* com.ethan.pagerview.ui.TRect.getScreenWidth(getContext());
        ...
        LinearLayout.LayoutParams testParams = new LinearLayout.LayoutParams(com.ethan.pagerview.ui.TRect.getScreenWidth(getContext())*numColumns, com.ethan.pagerview.ui.TRect.getScreenHeight(getContext()));
    ...
    private void initGridView() {
        ...
        gridView.setColumnWidth(com.ethan.pagerview.ui.TRect.getScreenWidth(getContext()));
        LinearLayout.LayoutParams gridViewLayoutParams = new LinearLayout.LayoutParams(com.ethan.pagerview.ui.TRect.getScreenWidth(getContext())*numColumns, com.ethan.pagerview.ui.TRect.getScreenHeight(getContext()));
...
//        });
    ...
    private void initPageControl() {
        ...
        LayoutParams layoutParams = new LayoutParams(com.ethan.pagerview.ui.TRect.getScreenWidth(getContext()),60);
        layoutParams.topMargin = com.ethan.pagerview.ui.TRect.getScreenHeight(getContext()) - 100;
...
//            PropertyValuesHolder scaleHolder = PropertyValuesHolder.ofFloat("scale", mTransfrom.startScale, mTransfrom.endScale);
            ...
            PropertyValuesHolder widthHolder = PropertyValuesHolder.ofFloat("width", originalRect.getWidth(), com.ethan.pagerview.ui.TRect.getScreenWidth(getContext()));
            PropertyValuesHolder heightHolder = PropertyValuesHolder.ofFloat("height", originalRect.getHeight(), com.ethan.pagerview.ui.TRect.getScreenHeight(getContext()));
