...
public class TNinePlaceGridView extends GridView {
    ...
    int itemWidth = (com.ethan.pagerview.ui.TRect.getScreenWidth(getContext()) - 68*2 - itemGap*2)/3;
...
//        setColumnWidth(itemWidth);
    ...
    public class GridViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            if (view == null) {
                view = new com.ethan.pagerview.ui.TScallImageView(context);
                com.ethan.pagerview.ui.TScallImageView imageView = (com.ethan.pagerview.ui.TScallImageView) view;
